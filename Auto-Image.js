; (async () => {
    ...
    async function swapAccount(token) {
        return new Promise((resolve, reject) => {
            ...
            function handler(event) {
                ...
                if (event.data.type === "cookieSet") {
                    ...
                    console.log("Cookie confirmed set:", event.data.value);
    ...
    const accounts = [
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjQxMjU3MDgsInNlc3Npb25JZCI6IlFvOGYzdVRBMWVqbllPdVdJTU9TcnlBa0JSV3FWQ3l0RjUxbmdqQ3hwMGc9IiwiaXNzIjoid3BsYWNlIiwiZXhwIjoxNzU4MjU2MDc4LCJpYXQiOjE3NTU2NjQwNzh9.8yjPGhbxiJoWgiYWJPybJfyI0G_sfWbI7ZRbpPlKpm4",
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjUzNTA0MTUsInNlc3Npb25JZCI6IlQ2eVAxNVotaFBHWTN2MTBlLThtS3VIX05WSFhuYWEtSEItcWJIYTNSMVE9IiwiaXNzIjoid3BsYWNlIiwiZXhwIjoxNzU4MjU2MTUxLCJpYXQiOjE3NTU2NjQxNTF9.fmd1w_NZa6iohTWk4g1ZQo0zkP3PrvePGkPjmySt5Hs",
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjU3MjY4NDQsInNlc3Npb25JZCI6InNpU3RVZEJpdUoyUDhJbDJ3UW5JQS1rYlp4MzhFa1d1VlpHbm1lVi1nRVk9IiwiaXNzIjoid3BsYWNlIiwiZXhwIjoxNzU4MjU2MjE2LCJpYXQiOjE3NTU2NjQyMTZ9.maccgnDTOKBoprzUer11lmTatffKnGPEYVKj4I7QS3g",
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjUyMjQ3NzMsInNlc3Npb25JZCI6Ii1jRjFpQVJKYWlXU3UtYUwxSmthczZiM1Q0VFNIV1dPQ0FWR1JpZFdfTmM9IiwiaXNzIjoid3BsYWNlIiwiZXhwIjoxNzU4MjU2MjgxLCJpYXQiOjE3NTU2NjQyODF9.BVmCVB-BIQGeiErSiLxbXHK-oN-antPImcAm9--Mtio",
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjU3MzAzODIsInNlc3Npb25JZCI6IkJWdFJ0YWdZV09zQzE5UGowNnJfWnVlakFXYWkyX0N4MlNidWxzNkY3OGc9IiwiaXNzIjoid3BsYWNlIiwiZXhwIjoxNzU4MjU2Mzg5LCJpYXQiOjE3NTU2NjQzODl9.1dTIHkBsVPqcfPcj0QYb7rbnyZpH7mWa2s6zBX2FFT0",
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjU1MjcyMzMsInNlc3Npb25JZCI6ImQ5UE5JOFVtbHV0UlhNSnZteExmQkhTTXBEQ2dyak5kd0NOMXJBY3d2d1k9IiwiaXNzIjoid3BsYWNlIiwiZXhwIjoxNzU4MjU2NDQ2LCJpYXQiOjE3NTU2NjQ0NDZ9.6s0ORuVgfpM_XRYykAW6-IYhbEZwdbYRzfdPbxb4MGw",
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjU3MzQyNTUsInNlc3Npb25JZCI6IlEtYm1hdEJTM2RSS0J5NWszX0h4QjZBZDJXYWRpa2ZwSnV5WGVuTF9aVFE9IiwiaXNzIjoid3BsYWNlIiwiZXhwIjoxNzU4MjU2NTU1LCJpYXQiOjE3NTU2NjQ1NTV9.7ZDH7MF3BQP_1JJ4NDFy4oPR_hChA3bR3_DxKRYSq3A",
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjU3MzY3NTIsInNlc3Npb25JZCI6ImN5NWQ1eDhVOVBVMlNESlRNRlhBcXBqOElZb2ZRcUxNWlU0WVFod0p1eVE9IiwiaXNzIjoid3BsYWNlIiwiZXhwIjoxNzU4MjU2NjMyLCJpYXQiOjE3NTU2NjQ2MzJ9.8ZKv1QMDiodq1cEkPIoT-LveYJ2Pvs3u4nOpcFipV78",
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjU1NDMzODUsInNlc3Npb25JZCI6Ilh3bHhlSExTT29SNzlFaENVanFWNFRIQkJ5d29YWGs4aC0wR1M5Si1vQ2c9IiwiaXNzIjoid3BsYWNlIiwiZXhwIjoxNzU4MzUwMzE0LCJpYXQiOjE3NTU3NTgzMTR9.DJBv9UOGrE7HPitc3ic5B_T4HAh-BD-sIbfjz41kpqs",
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjUyMDY0MjgsInNlc3Npb25JZCI6IndJSjlzbXhxV1BEVzFRdFViTGIxLWVnRVhCMW51TFlTZmVPRjkxRTJNT2M9IiwiaXNzIjoid3BsYWNlIiwiZXhwIjoxNzU4MTg4MTM3LCJpYXQiOjE3NTU1OTYxMzd9.RaAa0_D1qpccylCdAxHquz7hA9NpyzOsMtzJhTcdHeo"
    ];

    async function fetchAllaccounts() {
        for (let i = 0; i < 10; i++) {
            let token = accounts[i];
            // console.log("User's token :", token);
            await swapAccount(token);
            setTimeout(10);
